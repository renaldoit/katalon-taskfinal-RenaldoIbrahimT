...
WebUI.waitForElementVisible(findTestObject('Page Checkout Automation Practice Site/LabelBillingFirstNameisarequiredfield'), 
    0)

WebUI.verifyElementText(findTestObject('Page Checkout Automation Practice Site/LabelBillingFirstNameisarequiredfield'), 
