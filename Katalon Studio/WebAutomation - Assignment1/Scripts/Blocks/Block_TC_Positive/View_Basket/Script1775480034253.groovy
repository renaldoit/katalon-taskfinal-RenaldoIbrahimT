...
WebUI.verifyElementText(findTestObject('Object Repository/PageBasketAutomationPracticeSite/List Product_Functional Programming in JS'), 
    'Functional Programming in JS')

WebUI.verifyElementText(findTestObject('Object Repository/PageBasketAutomationPracticeSite/List Product_Android Quick Start Guide'), 
